...
// Pull brand icons from React Icons (FontAwesome 6)
import { FaGithub, FaInstagram, FaLinkedin, FaHeart } from "react-icons/fa6";
  ...
  return (
    <footer className="bg-[#050505] border-t border-white/5 pt-16 pb-8 px-4 md:px-8 mt-auto w-full z-20 relative">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
        ...
        <div className="md:col-span-2">
          ...
          <p className="text-white/40 text-xs md:text-sm font-medium leading-relaxed max-w-sm mb-6">
            Stop planning and start exploring. Generate hyper-personalized
            itineraries, manage your packing lists, and map out your next
            adventure in seconds with AI intelligence.
          </p>
          <div className="flex gap-4">
            <a
              href="https://www.linkedin.com/in/arpan-pal-2k04/"
              target="_blank"
        ...
        <div>
          ...
          <ul className="space-y-4">
            {/* <li>
              <Link
                to="/"
                className="text-white/50 hover:text-orange-500 text-[10px] md:text-xs font-bold uppercase tracking-wider transition-colors"
              >
                Home
              </Link>
            </li> */}
      ...
      <div className="max-w-7xl mx-auto border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-white/50 text-[12px] font-bold uppercase tracking-widest text-center md:text-left">
          © {new Date().getFullYear()} Journeys. All rights reserved.
        </p>
        <p className="text-white/70 text-[14px] font-bold uppercase tracking-widest flex items-center gap-1.5">
          Built with{" "}
